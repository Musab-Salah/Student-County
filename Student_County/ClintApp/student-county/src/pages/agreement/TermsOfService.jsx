...
const TermsOfService = () => {
  return (
    <>
      ...
      <p>Last updated: 2023-06-25</p>
      <p>
        1. <b>Introduction</b>
      </p>
      <p>
        Welcome to <b>Student County</b> (“Company”, “we”, “our”, “us”)!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <b>student-county.com</b> (together or
        individually “Service”) operated by <b>Student County</b>.
      </p>
      <p>
      ...
      <p>
        ...
        <b>support@student-county.com</b> so we can try to find a solution.
      ...
      <p>
        Student County has the right but not the obligation to monitor and edit
        all Content provided by users.
      </p>
      <p>
        In addition, Content found on or through this Service are the property
        of Student County or used with permission. You may not distribute,
      ...
      <p>
        ...
        Student County and its licensors. Service is protected by copyright,
        ...
        written consent of Student County.
      </p>
      <p>
      ...
      <p>
        ...
        to support@student-county.com, with the subject line: “Copyright
      ...
      <p>
        You may provide us either directly at support@student-county.com or via
      ...
      <p>
        ...
        are not owned or controlled by Student County.
      </p>
      <p>
        Student County has no control over, and assumes no responsibility for
      ...
      <p>
        ...
        of Palestine, which governing law applies to agreement without regard to
      ...
      <p>
        ...
        email: <b>support@student-county.com</b>.
      </p>
      <p style={{ marginTop: "5em", fontSize: "0.7em" }}>
        ...
        were created for <b>student-county.com</b> by{" "}
        <a href="https://policymaker.io">PolicyMaker.io</a> on 2023-06-25.
      </p>
    </>
  );
};
