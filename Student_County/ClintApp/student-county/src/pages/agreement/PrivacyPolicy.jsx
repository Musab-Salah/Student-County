...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      <p>Effective date: 2023-06-25</p>
      <p>
        1. <b>Introduction</b>
      </p>
      <p>
        Welcome to <b> Student County</b>.
      </p>
      <p>
        <b>Student County</b> (“us”, “we”, or “our”) operates{" "}
        <b>student-county.com</b> (hereinafter referred to as <b>“Service”</b>).
      </p>
      <p>
        Our Privacy Policy governs your visit to <b>student-county.com</b>, and
      ...
      <p>
        <b>SERVICE</b> means the student-county.com website operated by Student
        County.
      </p>
      <p>
      ...
      <p>Student County uses the collected data for various purposes:</p>
      ...
      <p>
        If you are located outside Palestine and choose to provide information
        to us, please note that we transfer the data, including Personal Data,
        to Palestine and process it there.
      </p>
      <p>
      ...
      <p>
        Student County will take all the steps reasonably necessary to ensure
      ...
      <p>
        ...
        <b>support@student-county.com</b>.
      </p>
      <p>
      ...
      <p>
        ...
        at <b>support@student-county.com</b>.
      </p>
      ...
      <p>
        ...
        please send your request(s) by email: <b>support@student-county.com</b>.
      </p>
      <p>
