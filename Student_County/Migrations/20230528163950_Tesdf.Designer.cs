...
namespace Student_County.Migrations
{
    ...
    [Migration("20230528163950_Tesdf")]
    partial class Tesdf
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Student_County.DAL.CollegeEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "Ini",
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 5, 28, 16, 39, 50, 592, DateTimeKind.Unspecified).AddTicks(3263), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            ModifiedBy = "Ini",
                            ModifiedOn = new DateTimeOffset(new DateTime(2023, 5, 28, 16, 39, 50, 592, DateTimeKind.Unspecified).AddTicks(3265), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "EIT"
                        });
                });
            ...
            modelBuilder.Entity("Student_County.DAL.UniversityEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "Ini",
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 5, 28, 16, 39, 50, 592, DateTimeKind.Unspecified).AddTicks(3221), new TimeSpan(0, 0, 0, 0, 0)),
                            EmailDomainName = "@student.aaup.edu",
                            IsDeleted = false,
                            ModifiedBy = "Ini",
                            ModifiedOn = new DateTimeOffset(new DateTime(2023, 5, 28, 16, 39, 50, 592, DateTimeKind.Unspecified).AddTicks(3225), new TimeSpan(0, 0, 0, 0, 0)),
