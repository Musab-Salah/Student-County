...
namespace Student_County.Migrations
{
    ...
    [Migration("20230526213419_Chataadf")]
    partial class Chataadf
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Student_County.DAL.CollegeEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "Ini",
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 5, 26, 21, 34, 19, 19, DateTimeKind.Unspecified).AddTicks(5047), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            ModifiedBy = "Ini",
                            ModifiedOn = new DateTimeOffset(new DateTime(2023, 5, 26, 21, 34, 19, 19, DateTimeKind.Unspecified).AddTicks(5048), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "EIT"
                        });
                });
            ...
            modelBuilder.Entity("Student_County.DAL.UniversityEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "Ini",
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 5, 26, 21, 34, 19, 19, DateTimeKind.Unspecified).AddTicks(5012), new TimeSpan(0, 0, 0, 0, 0)),
                            EmailDomainName = "@student.aaup.edu",
                            IsDeleted = false,
                            ModifiedBy = "Ini",
                            ModifiedOn = new DateTimeOffset(new DateTime(2023, 5, 26, 21, 34, 19, 19, DateTimeKind.Unspecified).AddTicks(5016), new TimeSpan(0, 0, 0, 0, 0)),
